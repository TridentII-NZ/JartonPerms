 ...
 */
package me.jarton.perms.impl.subject;
...
import me.jarton.perms.subject.SubjectDataCache;
...
public final class SubjectDataCacheImpl<I> implements SubjectDataCache<I> {
    ...
    public void cacheAll() {
        dataStore.getAllIdentifiers(this.type.name()).forEach(ident -> {
            try {
    ...
    public Stream<I> getAllIdentifiers() {
        return this.dataStore.getAllIdentifiers(type.name())
